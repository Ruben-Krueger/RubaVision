		...
		<AppShell header={{ height: 60 }} padding="md">
			...
			<AppShell.Main>
				<Container>
					...
					or medical decision-making purposes is solely at the user`&apos;s own
					risk. The accuracy, reliability, and suitability of this software for
					any particular purpose are not guaranteed. Users are responsible for
